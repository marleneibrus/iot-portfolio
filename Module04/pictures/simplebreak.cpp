...
// char* super_message; // Incorrectly initialised, will breajk the code:()
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  /* Serial.print("Something special coming up...");
  super_message[0] = 'A';
  Serial.print(super_message); */
...
void loop() {
  ...
  if (now - lastMsg > 2000) {
    lastMsg = now;
    --value;
    snprintf (msg, MSG_BUFFER_SIZE, "hello world #%ld - division %f", value, 1000 / value);
